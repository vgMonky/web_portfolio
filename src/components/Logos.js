...
import { FaHtml5, FaCss3Alt, FaJs, FaReact, FaPython, FaFigma, FaVuejs} from 'react-icons/fa';
...
const LogoSet = () => (
  <>
    ...
    <FaVuejs className="logo vue" title="Vue" onClick={() => window.open('https://vuejs.org/')}/>
